        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start z-10">
              <span className="inline-block text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#FF1F3D] mb-1.5 sm:mb-3 bg-[#FF1F3D]/10 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full border border-[#FF1F3D]/20 animate-pulse-glow">
                {t.hero.eyebrow}
              </span>
