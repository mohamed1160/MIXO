        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-gray-200 dark:border-[#1E2630]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 mt-2">
              ...
              {/* WhatsApp Link */}
              <a
                href={storeSettings.whatsappUrl || (storeSettings.supportPhone ? `https://wa.me/2${storeSettings.supportPhone.replace(/[^\d]/g, '')}` : 'https://wa.me/201012345678')}
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-full bg-white dark:bg-[#151C24] hover:bg-emerald-500 hover:text-white dark:hover:bg-emerald-600 border border-gray-200 dark:border-[#26313D] flex items-center justify-center text-gray-700 dark:text-[#AAB4C0] transition-colors shadow-sm"
                aria-label="WhatsApp"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
